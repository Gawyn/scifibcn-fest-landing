...
const translations = {
  ...
  es: {
    ...
    'rules.awards.content': 'Las películas en la Competición Oficial son elegibles para los siguientes premios:',
    'rules.awards.bestFilm': 'Mejor Cortometraje – Competición Oficial',
  ...
  ca: {
    ...
    'rules.awards.content': 'Les pel·lícules en la Competició Oficial són elegibles per als següents premis:',
    'rules.awards.bestFilm': 'Millor Curtmetratge – Competició Oficial',
